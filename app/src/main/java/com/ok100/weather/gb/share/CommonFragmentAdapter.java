 ...
 * @date 2015-7-15
 */
public class CommonFragmentAdapter extends PagerAdapter implements OnPageChangeListener {
    ...
    public CommonFragmentAdapter(List<Fragment> fragments, FragmentManager fragmentManager, ViewPager viewPager) {
